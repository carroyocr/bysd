...
class MainView extends Ui.View {
    ...
    function _arco(dc, cx, cy, radio, fraccion, color, grosor) {
        ...
        // Un circulo entero acabaria en el mismo angulo en que empieza, y
        // drawArc no dibujaria nada.
        ...
        var fin = 90 - (360 * fraccion);
        while (fin < 0) { fin += 360; }
        dc.setPenWidth(grosor);
        dc.setColor(color, Gfx.COLOR_TRANSPARENT);
        dc.drawArc(cx, cy, radio, Gfx.ARC_CLOCKWISE, 90, fin.toNumber());
    }
