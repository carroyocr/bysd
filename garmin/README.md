...
> errores ni avisos para los 42 relojes de la lista —AMOLED y MIP—. Lo que
...
- **Compilación.** Los dos proyectos, para los 42 relojes de la lista, sin un
  solo error ni aviso: 78 builds cada uno en el export de tienda.
