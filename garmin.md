...
**La 1.5.0 está empaquetada y sin subir** (9 de septiembre de 2026;
`garmin/build/backyard.iq`, 181 builds de **111 relojes**, sin error ni aviso).
Entra la generación **fēnix 9** entera, a petición de un usuario de la tienda
que pidió el fēnix 9 Pro para noviembre, y con ella la **primera familia de
pantalla nueva del proyecto**, `round-466x466` (el 9 Pro 51 mm). No hizo falta
dibujar nada. Falta subirla al portal y pasar revisión.
