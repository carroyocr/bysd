...
def generate_payment_reminder_email(nombre: str, race_name: str, payment_info: dict, upload_url: str, cancel_url: str) -> str:
    ...
    <body style="margin: 0; padding: 0; font-family: Arial, Helvetica, sans-serif; background-color: #f5f5f4;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
            ...
            <div style="background: linear-gradient(135deg, #ea580c 0%, #f97316 100%); padding: 24px; text-align: center;">
                <h1 style="color: white; margin: 0; font-size: 20px; font-weight: bold;">BACKYARD ULTRA SANTO DOMINGO</h1>
            </div>
            ...
            <div style="padding: 32px 24px;">
                ...
                <div style="background-color: #f0fdf4; border-radius: 12px; padding: 24px; margin-bottom: 24px; border: 1px solid #86efac;">
                    <h3 style="margin: 0 0 16px 0; color: #166534; font-size: 14px; font-weight: 600;">
                ...
                <div style="text-align: center; margin: 32px 0;">
                    <a href="{upload_url}" style="display: inline-block; background: linear-gradient(135deg, #ea580c 0%, #f97316 100%); color: white; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-size: 14px; font-weight: 600;">
                        Subir Comprobante de Pago
                    </a>
                </div>
                
                <!-- Warning Notice -->
                <div style="background-color: #fef2f2; border-radius: 12px; padding: 16px 20px; margin-bottom: 24px; border-left: 4px solid #ef4444;">
                    <p style="margin: 0; color: #991b1b; font-size: 14px; line-height: 1.6;">
                        <strong>Importante:</strong> Si el pago no se realiza dentro de los 30 días, tu pre-registro será desestimado y perderás tu cupo.
                    </p>
                </div>
                ...
                <div style="text-align: center; padding-top: 16px; border-top: 1px solid #e5e7eb;">
                    ...
                    <a href="{cancel_url}" style="color: #6b7280; font-size: 13px; text-decoration: underline;">
